...
const Hero = () => {
  ...
  return <section id="hero" className="min-h-screen flex items-center justify-center pt-16 relative overflow-hidden">
      {/* Custom cursor light effect */}
      <div className="pointer-events-none fixed w-48 h-48 rounded-full bg-white/60 mix-blend-overlay blur-xl z-50" style={{
      ...
      <div className="absolute inset-0 z-0">
        ...
        <video autoPlay loop muted className="w-full h-full object-cover" style={{
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center animate-fade-up">
          <h1 className="text-4xl sm:text-5xl md:text-7xl font-bold text-white mb-6">Skills Portfolio</h1>
          ...
          <a href="#skills" className="inline-block bg-portfolio-primary text-white px-8 py-3 rounded-lg hover:bg-portfolio-primary/90 transition-colors focus:outline-none focus:ring-2 focus:ring-portfolio-primary focus:ring-offset-2 focus:ring-offset-black" aria-label="Scopri le mie competenze">
